...
export function setSurveyResponses(surveyResult) {
    return {
        type: SET_SURVEY_RESULT,
        SurveyResultAnswers: surveyResult.SurveyResultAnswers
    };
}
...
export function fetchSurveyQuestions(id) {
    return function(dispatch) {
        ...
        return Promise.all([
            ...
            fetch('/api/v1/surveyresult/getOne', {
            ...
            .then(([questions, survey, surveyresult]) => {
                ...
                dispatch(setSurveyResponses(surveyresult));
            })
